      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','等级', '服务器','用户ID', '帐号', '平台', '操作系统',  '总金额', '元宝类型','元宝类型','元宝路径', '元宝']
           const filterVal = ['logtime', 'roleid', 'rolename','params3', 'serverid','userid', 'account', 'params2','params6', 'params8', 'serverid', 'serverid','serverid', 'serverid']
