      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称', '服务器','用户ID', '帐号', '平台', '操作系统',  '任务类型ID', '任务ID','战斗','时间', '结果']
           const filterVal = ['logtime', 'roleid', 'rolename', 'serverid','userid', 'account', 'params1','params3', 'params6', 'params8', 'params7','params5', 'params4']
