      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','等级','服务器','用户ID', '帐号', '平台', '操作系统',  '物品类型', '物品ID','物品名称','物品数量', '元宝类型','元宝','总金额']
           const filterVal = ['logtime', 'roleid', 'rolename', 'params5','serverid','userid', 'account', 'params3','params6', 'params9', 'params4', 'params4','params1', 'params10', 'params7','params8']
