      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称', '服务器','用户ID', '帐号', '平台', '操作系统',  '敌方角色ID', '竞技场ID','战斗','时间', '结果']
           const filterVal = ['logtime', 'roleid', 'rolename', 'serverid','userid', 'account', 'params5','params1', 'params4', 'params2', 'params8','params7', 'params6']
