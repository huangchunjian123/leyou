      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','等级', '服务器','用户ID', '帐号', '平台', '操作系统',  '总金额', 'VIP等级','频道','消息']
           const filterVal = ['logtime', 'roleid', 'rolename','params8', 'serverid','userid', 'account', 'params6','params2', 'params4', 'params7', 'params3','params1']
