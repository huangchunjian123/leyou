      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','等级', '服务器','用户ID', '帐号', '平台', '操作系统',  'ip地址', '总金额','PID']
           const filterVal = ['logtime', 'roleid', 'rolename','params6', 'serverid','userid', 'account', 'params5','params1', 'params2', 'params3', 'params4']
