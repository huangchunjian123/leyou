      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','职业', '服务器','用户ID', '帐号', '平台', '操作系统',  'MAC地址']
           const filterVal = ['logtime', 'roleid', 'rolename', 'params1', 'serverid','userid', 'account', 'params5','params2', 'params4']
