      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称', '服务器','用户ID', '帐号', '平台', '操作系统',  '战斗', 'chapterID','ectypeID']
           const filterVal = ['logtime', 'roleid', 'rolename', 'serverid','userid', 'account', 'params3','params1', 'params6', 'params4', 'params5']
