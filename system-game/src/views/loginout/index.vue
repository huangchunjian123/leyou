      ...
      handleSearch() {
        ...
        exportExcel() {        
         import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['记录时间', '角色ID', '角色名称','等级', '服务器','用户ID', '帐号', '平台', '操作系统',  '剩余虚拟币', '剩余元宝','绑定剩余元宝','在线时长（秒）', 'PID']
           const filterVal = ['logtime', 'roleid', 'rolename','params3', 'serverid','userid', 'account', 'params2','params6', 'params4', 'params5', 'params7','params9', 'params1']
