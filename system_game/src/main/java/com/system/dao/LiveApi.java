...
public class LiveApi {
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAIrxm1EQVIMKye";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "za0R6kIUbvQGytSCM6upmeqnE0yv6S";
    ...
    private final static Logger LOG = Logger.getLogger(LiveApi.class.getName());
    ...
    private static Map<String, String> generatePrivateParamters() {
        ...
        // 视频ID
        privateParams.put("Action", "DescribeLivePullStreamConfig");
        privateParams.put("DomainName", "hjxxavldown.loyin.com.cn");
