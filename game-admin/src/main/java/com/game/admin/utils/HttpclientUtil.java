...
public class HttpclientUtil {
	 ...
	 * @return 响应消息
	 */
	public static HttpResponse get(String domain,String url) {
		return get(domain,url, null, null);
	}
	 ...
	 * @return 响应消息
	 */
	public static HttpResponse get(String domain,String url, Map<String, String> params,
			String charset) {
		if (url == null || StringUtils.isEmpty(url) || StringUtils.isEmpty(domain)) {
			return null;
		}
