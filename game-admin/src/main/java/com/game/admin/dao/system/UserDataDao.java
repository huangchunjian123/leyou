...
public interface UserDataDao {
	...
	@SQL("select id,create_date_time as createDateTime ,modify_date_time as modifyDateTime,name,pwd,role_id as roleId,mail,mobile,real_name as realName from t_user t where t.id=:id")
	public UserData get(@SQLParam("id") int id);

	@SQL("select id,create_date_time as createDateTime ,modify_date_time as modifyDateTime,name,pwd,role_id as roleId,mail,mobile,real_name as realName from t_user")
